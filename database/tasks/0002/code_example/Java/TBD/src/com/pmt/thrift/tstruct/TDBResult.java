...
public class TDBResult implements org.apache.thrift.TBase<TDBResult, TDBResult._Fields>, java.io.Serializable, Cloneable, Comparable<TDBResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDBResult");
  ...
  static {
    schemes.put(StandardScheme.class, new TDBResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TDBResultTupleSchemeFactory());
  }

  public int err; // required
  public ByteBuffer val; // optional
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDBResult.class, metaDataMap);
  }
   ...
   */
  public TDBResult(TDBResult other) {
  ...
  public TDBResult deepCopy() {
    return new TDBResult(this);
  }
  ...
  public TDBResult setErr(int err) {
    this.err = err;
    setErrIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TDBResult)
      return this.equals((TDBResult)that);
    return false;
  }

  public boolean equals(TDBResult that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TDBResult other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TDBResult(");
    boolean first = true;
  ...
  private static class TDBResultStandardSchemeFactory implements SchemeFactory {
    public TDBResultStandardScheme getScheme() {
      return new TDBResultStandardScheme();
    }
  }

  private static class TDBResultStandardScheme extends StandardScheme<TDBResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDBResult struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDBResult struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TDBResultTupleSchemeFactory implements SchemeFactory {
    public TDBResultTupleScheme getScheme() {
      return new TDBResultTupleScheme();
    }
  }

  private static class TDBResultTupleScheme extends TupleScheme<TDBResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDBResult struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDBResult struct) throws org.apache.thrift.TException {
